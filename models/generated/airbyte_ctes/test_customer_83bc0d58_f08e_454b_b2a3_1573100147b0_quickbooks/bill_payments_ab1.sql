...
-- depends_on: {{ source('test_customer_83bc0d58_f08e_454b_b2a3_1573100147b0_quickbooks', '_airbyte_raw_bill_payments') }}
select
...
from {{ source('test_customer_83bc0d58_f08e_454b_b2a3_1573100147b0_quickbooks', '_airbyte_raw_bill_payments') }} as table_alias
-- bill_payments
where 1 = 1
