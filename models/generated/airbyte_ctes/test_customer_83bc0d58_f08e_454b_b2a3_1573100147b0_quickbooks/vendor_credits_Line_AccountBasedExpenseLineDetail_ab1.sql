...
-- depends_on: {{ ref('vendor_credits_Line') }}
select
    _airbyte_Line_hashid,
    {{ json_extract('table_alias', 'AccountBasedExpenseLineDetail', ['ClassRef'], ['ClassRef']) }} as ClassRef,
...
from {{ ref('vendor_credits_Line') }} as table_alias
